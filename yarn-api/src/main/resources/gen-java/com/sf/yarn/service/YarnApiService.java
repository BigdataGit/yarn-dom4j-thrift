...
public class YarnApiService {
  ...
  public interface Iface {
    ...
    public boolean delQueueResource(java.util.List<java.lang.String> queueName) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void addQueueResource(java.util.List<QueueParam> paras, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException;

    public void delQueueResource(java.util.List<java.lang.String> queueName, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException;

    public void updateQueueResource(java.util.List<QueueParam> paras, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_delQueueResource(java.util.List<java.lang.String> queueName) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class addQueueResource_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Boolean> {
      private java.util.List<QueueParam> paras;
      public addQueueResource_call(java.util.List<QueueParam> paras, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class delQueueResource_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Boolean> {
      private java.util.List<java.lang.String> queueName;
      public delQueueResource_call(java.util.List<java.lang.String> queueName, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class updateQueueResource_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Boolean> {
      private java.util.List<QueueParam> paras;
      public updateQueueResource_call(java.util.List<QueueParam> paras, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.paras = paras;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class addQueueResource<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addQueueResource_args, java.lang.Boolean> {
      public addQueueResource() {
        super("addQueueResource");
      }
      ...
      public void start(I iface, addQueueResource_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
        iface.addQueueResource(args.paras,resultHandler);
      }
    }

    public static class delQueueResource<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, delQueueResource_args, java.lang.Boolean> {
      public delQueueResource() {
        super("delQueueResource");
      }
      ...
      public void start(I iface, delQueueResource_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
        iface.delQueueResource(args.queueName,resultHandler);
      }
    }

    public static class updateQueueResource<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, updateQueueResource_args, java.lang.Boolean> {
      public updateQueueResource() {
        super("updateQueueResource");
      }
      ...
      public void start(I iface, updateQueueResource_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class addQueueResource_args implements org.apache.thrift.TBase<addQueueResource_args, addQueueResource_args._Fields>, java.io.Serializable, Cloneable, Comparable<addQueueResource_args>   {
    ...
    public int compareTo(addQueueResource_args other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetParas()).compareTo(other.isSetParas());
      if (lastComparison != 0) {
    ...
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("addQueueResource_args(");
      boolean first = true;
  ...
  public static class addQueueResource_result implements org.apache.thrift.TBase<addQueueResource_result, addQueueResource_result._Fields>, java.io.Serializable, Cloneable, Comparable<addQueueResource_result>   {
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("addQueueResource_result(");
      boolean first = true;
  ...
  public static class delQueueResource_args implements org.apache.thrift.TBase<delQueueResource_args, delQueueResource_args._Fields>, java.io.Serializable, Cloneable, Comparable<delQueueResource_args>   {
    ...
    public java.util.List<java.lang.String> queueName; // required
    ...
    public delQueueResource_args(
      java.util.List<java.lang.String> queueName)
    {
      this();
      this.queueName = queueName;
    }
    ...
    public delQueueResource_args(delQueueResource_args other) {
      if (other.isSetQueueName()) {
        java.util.List<java.lang.String> __this__queueName = new java.util.ArrayList<java.lang.String>(other.queueName);
    ...
    public java.util.Iterator<java.lang.String> getQueueNameIterator() {
      return (this.queueName == null) ? null : this.queueName.iterator();
    }

    public void addToQueueName(java.lang.String elem) {
      if (this.queueName == null) {
        this.queueName = new java.util.ArrayList<java.lang.String>();
      }
      this.queueName.add(elem);
    }

    public java.util.List<java.lang.String> getQueueName() {
      return this.queueName;
    }

    public delQueueResource_args setQueueName(java.util.List<java.lang.String> queueName) {
      this.queueName = queueName;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case QUEUE_NAME:
        if (value == null) {
          ...
          setQueueName((java.util.List<java.lang.String>)value);
        }
        break;
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("delQueueResource_args(");
      boolean first = true;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.queueName = new java.util.ArrayList<java.lang.String>(_list8.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, delQueueResource_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.queueName != null) {
          oprot.writeFieldBegin(QUEUE_NAME_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter11 : struct.queueName)
            {
        ...
        if (struct.isSetQueueName()) {
          {
            ...
            for (java.lang.String _iter12 : struct.queueName)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.queueName = new java.util.ArrayList<java.lang.String>(_list13.size);
  ...
  public static class delQueueResource_result implements org.apache.thrift.TBase<delQueueResource_result, delQueueResource_result._Fields>, java.io.Serializable, Cloneable, Comparable<delQueueResource_result>   {
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("delQueueResource_result(");
      boolean first = true;
  ...
  public static class updateQueueResource_args implements org.apache.thrift.TBase<updateQueueResource_args, updateQueueResource_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateQueueResource_args>   {
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("updateQueueResource_args(");
      boolean first = true;
  ...
  public static class updateQueueResource_result implements org.apache.thrift.TBase<updateQueueResource_result, updateQueueResource_result._Fields>, java.io.Serializable, Cloneable, Comparable<updateQueueResource_result>   {
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("updateQueueResource_result(");
      boolean first = true;
